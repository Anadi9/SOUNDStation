    ...
    <div className="footer">
      <div className="footer-content">
        ...
        <div className="col">
          ...
          <div className="c-item">
            <FaLocationArrow />
            <div className="text">Kayaloram Rd, Punnamada, Kottankulangara, Alappuzha, Kerala, 688006</div>
          </div>
          <div className="c-item">
            <FaMobileAlt />
      ...
      <div className="bottom-bar">
        <div className="bottom-bar-content">
          <span className="text">SOUNDStation 2022 CREATED BY RITIK KAINTURA. PREMIUM E-COMMERCE SOLUTIONS.</span>
          <img src={Payment} />
        </div>
      </div>
    </div>
